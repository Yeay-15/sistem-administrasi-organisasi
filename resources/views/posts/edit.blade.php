            ...
            <form action="{{ route('posts.update', $post->id) }}" method="POST" enctype="multipart/form-data" @submit="beforeSubmit">
                ...
                <div class="mt-5">
                    ...
                    <select name="category"
                        ...
                        <option value="Artikel & Berita" {{ old('category', $post->category) === 'Artikel & Berita' ? 'selected' : '' }}>Artikel & Berita</option>
                        <option value="Laporan Kegiatan" {{ old('category', $post->category) === 'Laporan Kegiatan' ? 'selected' : '' }}>Laporan Kegiatan</option>
                    </select>
